...
function toggleSidenav() {
  body.classList.contains(className)
    ...
    : (body.classList.add(className), iconSidenav.classList.remove("d-none"));
}
  ...
  if (e.getAttribute("checked")) {
    ...
    for (y = 0; y < r.length; y++)
      !r[y].classList.contains("text-white") ||
        ...
        (r[y].classList.remove("text-white"), r[y].classList.add("text-dark"));
    ...
    for (var y = 0; y < l.length; y++)
      l[y].classList.contains("text-dark") &&
        (l[y].classList.remove("text-dark"), l[y].classList.add("text-white"));
    ...
    for (var y = 0; y < g.length; y++)
      g[y].classList.remove("text-dark"), g[y].classList.add("text-white");
    for (var y = 0; y < L.length; y++)
        ...
        (e) => {
          e.forEach((e) => {
            e.isIntersecting &&
              (t(),
              (e = e.target),
              (e = document.querySelector(`a[href='#${e.id}']`))) &&
              e.classList.add("active");
          });
        },
